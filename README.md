...
```
pip install --user git+https://github.com/mwess/miit@v0.0.4
```
...
```
docker pull mwess89/miit:0.0.4
```

It should then be available to run as follows:

```
docker run -it -p 8888:8888 mwess89/miit:0.0.4
```
...
```
docker run -it -p 8888:8888 miit:0.0.4
```
