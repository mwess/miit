...
def get_pca_img(msi: pyimzml.ImzMLParser.ImzMLParser, 
    ...
    """Computes PCA image from MSI.

    Args:
        msi (pyimzml.ImzMLParser.ImzMLParser): 
        ref_mat (numpy.ndarray): 
        spec_to_ref_map (dict): 
        mz_threshold (float | None, optional): . Defaults to None.
...
def preprocess_histology(hist_img: numpy.ndarray, 
    ...
    Args:
        ...
        msi_img (numpy.ndarray): 
        hist_img_mask (numpy.ndarray | None, optional): Defaults to None.

    Returns:
        tuple[numpy.ndarray, dict]: Preprocessed image, dict with padding parameters
    """
    # Remove noise
...
def get_mode(msi: pyimzml.ImzMLParser.ImzMLParser, 
             use_auto: bool = False) -> str:
    """Get msi mode.

    Args:
        msi (pyimzml.ImzMLParser.ImzMLParser): 
        use_auto (bool, optional): Defaults to False.
...
def get_spec_type(msi: pyimzml.ImzMLParser.ImzMLParser, 
                  default_spec_type: str = 'centroid') -> str:
    """Get spec type from msi.

    Args:
        msi (pyimzml.ImzMLParser.ImzMLParser): 
        default_spec_type (str, optional): Defaults to 'centroid'.
...
def get_scan_direction(msi: pyimzml.ImzMLParser.ImzMLParser, 
                       default_scan_direction: str = 'top_down') -> str:
    """

    Args:
        msi (pyimzml.ImzMLParser.ImzMLParser): 
        default_scan_direction (str, optional): Defaults to 'top_down'.
...
def get_line_scan_direction(msi: pyimzml.ImzMLParser.ImzMLParser, 
                            default_scan_direction: str = 'line_left_right') -> str:
    """

    Args:
        msi (pyimzml.ImzMLParser.ImzMLParser): 
        default_scan_direction (str, optional): Defaults to 'line_left_right'.
...
def get_scan_pattern(msi: pyimzml.ImzMLParser.ImzMLParser, 
                     default_scan_pattern: str = 'one_way') -> str:
    """

    Args:
        msi (pyimzml.ImzMLParser.ImzMLParser): 
        default_scan_pattern (str, optional): Defaults to 'one_way'.
...
def get_scan_type(msi: pyimzml.ImzMLParser.ImzMLParser, 
                  default_scan_type: str = 'horizontal_line') -> str:
    """

    Args:
        msi (pyimzml.ImzMLParser.ImzMLParser): 
        default_scan_type (str, optional): Defaults to 'horizontal_line'.
