...
def resize_image_simple_sitk(image: numpy.ndarray | sitk.Image, 
                             res: tuple[int, int], 
...
class NiftyRegWrapper(Registerer):
    ...
    # Export images
        ...
        if nonrigid:
            ...
            m = string_mat_to_mat(aff_params)
    ...
    def transform_image(self, 
        ...
        # if isinstance(transformation.transform, str):
        #     m = string_mat_to_mat(transformation.transform)
        #     transform = sitk.AffineTransform(2)
        #     transform.SetMatrix((m[0, 0], m[0, 1], m[1, 0], m[1, 1]))
        #     transform.SetTranslation((m[0, 3], m[1, 3]))
        # else:
        #     transform = sitk.DisplacementFieldTransform(2)
        #     transform.SetDisplacementField(transformation.transform)
